...
* Li, K.; Yang, Y.; Chen, X.; He, Y.; __Sun, Z.__ 📩 (2025). Multilevel Control Functional (extended). [(Preprint)](https://arxiv.org/abs/2305.12996). <span style="display: inline-block; padding: 2px 8px; background-color: #e3f2fd; color: #1565c0; border: 1px solid #90caf9; border-radius: 4px; font-size: 0.85em; font-weight: 500; margin-left: 6px;">In International Conference on Learning Representations (ICLR 2026)</span>.
