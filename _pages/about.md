...
* __Sun, Z.__, Oates, C. J. & Briol, F-X. (2023). Meta-learning Control Variates: Variance Reduction with Limited Data. Accepted for publication In Proceedings of the 39th Conference on Uncertainty in Artificial Intelligence (__UAI 2023__). [(Preprint)](https://arxiv.org/abs/2303.04756)
    * This paper was accepted for an oral presentation at UAI.
*   __Sun, Z.__, Barp, A., Briol, F.-X.(2023). Vector-valued Control Variates. In Proceedings of the 40th International Conference on Machine Learning (__ICML 2023__). [(Preprint)](https://arxiv.org/abs/2109.08944) [(Conference)](https://proceedings.mlr.press/v202/sun23a.html)
